...
.. tip:: Double-clicking a discovered asset in the report grid opens the asset's Dashboard page. To see an asset-specific discovery report for the asset (across all existing discoveries), go to *Information → Discovery Report*.
