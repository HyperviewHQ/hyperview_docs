...
.. note:: Unknown assets will be listed under Asset Types. They will not appear in the Asset Hierarchy.

.. tip:: You can also run the discovery and see the run status from the Discovery Report page (*Discoveries → Overview → Details → Discovery Report*).
