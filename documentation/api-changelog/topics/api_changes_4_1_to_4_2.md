...
* Deleted property `portType` (string)

* Deleted property `portSide` (string)

* Deleted property `portSideValueId` (string)

* Deleted property `connectorType` (string)

* Deleted property `connectorTypeValueId` (string)
...
* Added property `portNameTemplate` (string)
...
* Changed content type : `application/json`
    ...
    * Changed property `imageFormat` (string)
