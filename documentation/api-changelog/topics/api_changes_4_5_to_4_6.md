# API Changelog 4.5 to 4.6

## What's New

### `POST` /api/asset/bulk/assets/muteAlarmEventNotifications

> Mutes alarm event notifications for many assets.


### `POST` /api/asset/bulk/assets/cancelMuteAlarmEventNotifications

> Cancels muted alarm event notifications for many assets.


### `POST` /api/asset/muteAlarmEventNotifications

> Mutes alarm event notifications for a specific asset.


### `DELETE` /api/asset/muteAlarmEventNotifications/{id}

> Cancels a mute alarm event notification setting for a specific asset.
...
* Added property `filteredCategories` (array)
...
* Changed content type : `application/json`
    ...
    * Added property `fileExtension` (string)
...
* Changed content type : `application/json`
    ...
    * Added property `alarmEventCategories` (array)
...
* Changed content type : `application/json`
    ...
    * Changed property `eventType` (string)
        ...
        * `muteAlarmEventNotificationSettingUpdated`
        * `muteAlarmEventNotificationSettingRemoved`
        * `alarmEventPolicyCategoriesUpdated`
...
* Changed content type : `application/json`
    ...
    * Added property `muteAlarmEventNotificationsSetting` (object)

        * Property `startTime` (string)
            > This value is assumed to be in UTC format.
