...
* Changed content type : `application/json`
    ...
    * Changed property `dataSetting` (string)
...
* Changed content type : `application/json`
    ...
    * Added property `rawValue` (object)
...
* Changed content type : `application/json`
    ...
    * Changed property `eventType` (string)
        ...
        * `discoveryProtocolPortWithProtocolAdded`
...
* Added property `circuitCarrier` (string)
