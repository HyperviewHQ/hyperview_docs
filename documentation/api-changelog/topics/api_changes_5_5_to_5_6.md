...
* Changed content type : `application/json`
    ...
    * Added property `offset` (number)

    * Added property `orderOfOperations` (string)
...
* Changed content type : `application/json`
    ...
    * Added property `components` (array)
...
* Changed content type : `application/json`
    ...
    * Added property `componentId` (string)
...
* Changed property `panelType` (string)
...
* Changed content type : `application/json`
    ...
    * Added property `valueSnmpOid` (string)
...
* Changed content type : `application/json`
    ...
    * Changed property `eventType` (string)
        ...
        * `bacnetIpDefinitionDescriptionUpdated`
        * `modbusTcpDefinitionDescriptionUpdated`
        * `modbusTcpComponentAdded`
        * `modbusTcpComponentUpdated`
        * `modbusTcpComponentDeleted`
        * `modbusTcpComponentSlaveAddressUpdated`
        * `modbusTcpDataInterpretationNonNumericSensorAdded`
        * `modbusTcpDataInterpretationNonNumericSensorUpdated`
        * `modbusTcpDataInterpretationNonNumericSensorDeleted`
        * `modbusTcpDataInterpretationNumericSensorAdded`
        * `modbusTcpDataInterpretationNumericSensorUpdated`
        * `modbusTcpDataInterpretationNumericSensorDeleted`
        * `bacnetIpDataInterpretationNumericSensorAdded`
        * `bacnetIpDataInterpretationNumericSensorUpdated`
        * `bacnetIpDataInterpretationNumericSensorDeleted`
