...
.. note:: For an actively used application session, a login from a **unique** user, browser and device combination can remain active for up to 15 days unless the user logs out or clears their browser cache.
