...
.. tip:: Create user groups before adding access policies. Refer to "Managing groups" in :ref:`User-administration-doc` for details. You can associate an asset with an existing access policy from the Access Control page (browse to asset → *Access Control*).
