...
.. tip:: You can review an asset's Sensors page (browse to asset → *Information → Sensors*) to see what sensors it has. Asset-specific events appear in the asset's Events page (browse to asset → *Events*).
...
---------------------------
.. note:: You cannot update an application-defined sensor threshold. However, you can disable or re-enable it.
...
---------------------------
.. note:: You cannot delete an application-defined sensor threshold.
