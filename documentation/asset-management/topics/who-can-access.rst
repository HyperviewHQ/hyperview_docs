...
#. Open the asset's Dashboard → *Access Control*.
#. Select the intended Policy → *Save* → *Save* or *Save and Apply to Child Assets*, as appropriate.
#. The "Save Changes?" modal will appear. Click Save to confirm the policy change.
