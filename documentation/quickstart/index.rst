...
.. |chromeLink| raw:: html
   ...
   <a href="https://www.google.com/chrome" class="external-link" target="_blank">Google Chrome</a>

.. |firefoxLink| raw:: html

   <a href="https://getfirefox.com" class="external-link" target="_blank">Mozilla Firefox</a>

.. |edgeLink| raw:: html

   <a href="https://www.microsoft.com/en-us/edge" class="external-link" target="_blank">Microsoft Edge (Chromium)</a>
...
.. tip:: You can also create a location from the right-click menu in the Asset Hierarchy (*right-click parent location → Add New Location*). Similarly, you can create non-location assets from the Asset Hierarchy, such as racks, PDUs, and so on (*right-click parent asset → Add New Asset*).
...
#. Open the Layout page of the location → *Edit*.
#. Drag the rack from the Asset Hierarchy to a grid tile in the location layout.
...
#. Open the Layout page of the rack → *Add Shelf*.
...
#. Open the rack layout page.
#. Drag the device from the Asset Hierarchy tree onto a rack unit in the rack elevation.
...
.. note:: Before you proceed, please make sure you have :ref:`set up Data Collectors<Setup-data-collectors>`. Only Administrators can perform discovery-related actions.
