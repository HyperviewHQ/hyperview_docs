.. include:: /using-hyperview/extracting-data/media.rst
.. _Extracting-data-doc:
...
.. note:: For :ref:`Advanced Search queries<Search-features>` the maximum export size is 10,000 rows.

.. tip:: The Sensors page also lets you export raw sensor data and sensor graphs. See :ref:`Managing sensors <Managing-sensors-doc>`.
